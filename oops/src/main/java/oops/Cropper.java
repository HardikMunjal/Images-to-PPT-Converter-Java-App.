...
public class Cropper extends JPanel
{
    ...
    public Cropper(BufferedImage image)
    {
        this.image = image;
    ...
    {
        File file = new File("G://dinesh//Source Images//export.png");
        Cropper test = new Cropper(ImageIO.read(file));
...
class ClipMover extends MouseInputAdapter
{
    ...
    {
        Point p = e.getPoint();
        if(cropper.clip.contains(p))
        {
            offset.x = p.x - cropper.clip.x;
            offset.y = p.y - cropper.clip.y;
            dragging = true;
        }
    }
